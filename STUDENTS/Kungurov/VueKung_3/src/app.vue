  ...
  <div class="super_container">
              ...
              >
                ...
                <div class="header_extra ml-auto">
                  <div class="shopping_cart">
                    <Cart ref="cart"/>
                    <div class="cart__content" id="cart-items"></div>
                  </div>
                  <div class="search">
              ...
              <ul class="page_menu_selection menu_mm">
                ...
                <li class="page_menu_item menu_mm">
                  <a href="checkout.html"
                    >Checkout<i class="fa fa-angle-down"></i
                  ></a>
                </li>
                <li class="page_menu_item menu_mm">
                  <a href="contact.html"
        ...
        <div class="owl-carousel owl-theme home_slider">
          ...
          <div class="owl-item home_slider_item">
            <div
              ...
              style="
                background-image: url(https://raw.githubusercontent.com/SergioElCringe/JS_step_1/main/TEST_FTP/static/home_slider_1.jpg);
              "
            ></div>
      ...
      >
        <div class="avds_small">
          <div
            ...
            style="
              background-image: url(https://raw.githubusercontent.com/SergioElCringe/JS_step_1/main/TEST_FTP/static/avds_small.jpg);
            "
          ></div>
          <div class="avds_small_inner">
            <div class="avds_discount_container">
              "./assets/img/discount.png" alt="">
              <div>
        ...
        <div class="avds_large">
          <div
            class="avds_background"
            style="
              background-image: url(https://raw.githubusercontent.com/SergioElCringe/JS_step_1/main/TEST_FTP/static/avds_large.jpg);
            "
          ></div>
          ...
          <div class="col">
            <div class="avds_xl_container clearfix">
              <div
                ...
                style="
                  background-image: url(https://raw.githubusercontent.com/SergioElCringe/JS_step_1/main/TEST_FTP/static/avds_xl.jpg);
                "
              ></div>
    ...
    <footer class="footer">
      <div
        ...
        style="
          background-image: url(https://raw.githack.com/SergioElCringe/JS_step_2/init/PROJECT/BASE__PROJECT/images/footer.jpg);
        "
      ></div>
      <div class="container">
        <div class="row">
