  ...
  <div class="product_details">
    <div class="container" v-if="!loading">
      <div class="row details_row">
        ...
        <Gallery :images="product.imgUrl" :productApi="productApi" :product="product"/>

        <!-- Product Content -->
        <div class="col-lg-6">
          <div class="details_content">
            <div class="details_name">{{ product.name }}</div>
            <div class="details_discount" v-if="product.category === 3">{{ product.discount }}</div>
            ...
            <div class="product_quantity_container">
              ...
              <div class="button cart_button button_custom">
                <span>Add</span>
              </div>
            </div>
...
export default {
  ...
  computed: {
    ...mapState({
      product: (state) => state.Catalog.product,
