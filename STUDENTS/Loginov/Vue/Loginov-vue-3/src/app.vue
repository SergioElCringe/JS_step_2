          ...
          <div class="row">
            <div class="col">
              ...
              >
                ...
                <nav class="main_nav" id="main_nav"></nav>
        ...
        <div class="owl-carousel owl-theme home_slider">
          ...
          <div class="owl-item home_slider_item">
            <div
              ...
              style="background-image: url(./assets/img/home_slider_1.jpg)"
            ></div>
      ...
      >
        <div class="avds_small">
          <div
            ...
            style="background-image: url(./assets/img/avds_small.jpg)"
          ></div>
        ...
        <div class="avds_large">
          <div
            class="avds_background"
            style="background-image: url(./assets/img/avds_large.jpg)"
          ></div>
          ...
          <div class="col">
            <div class="avds_xl_container clearfix">
              <div
                ...
                style="background-image: url(./assets/img/avds_xl.jpg)"
              ></div>
